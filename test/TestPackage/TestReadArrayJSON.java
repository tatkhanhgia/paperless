...
//        System.out.println(payload.replaceAll(pattern, "\"value\":\"base64\"}]}"));  
    String payload = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NzgxNzgxMTgyNDEsImlhdCI6MTY3ODE3NjMxODI0MSwiaXNzIjoiMyIsImF1ZCI6ImFjY291bnQiLCJ0eXAiOiJCZWFyZXIiLCJuYW1lIjoidGh1YW5ubiIsImVtYWlsIjoidGh1YW5ubkBtb2JpbGUtaWQudm4iLCJhenAiOiJCQ0RAR01BSUwuQ09NIn0.X1gpHA-iaDwSnRJ2dqDna1T23SrCuQB-4LT7o6rWQ7RTxTXbvFjMsquscaGKVDZlkMLO1edmZnPx3EHLJ6revPgf0WwKhdNm3LtKwHAI6dcCzyBTKHWPSB8qdDLcsCac3jygESFqB5VdWAfG1j88ZAPTj_E5ItjFGng_kEAMH4tKO5_EN62R4O57ijavIoGrTCQIkyTK4sB9nZ6K3S1FCwwjPeSyQQ4wmhsW19idnn4L5rT7jmSLW-lYKcF3RqJos6V-uj8oRUgvZAaQ8VsdjkrTNzkMLs_YTyg3myF_ZdbYpDDFgVWn1h5IXglt3IhwqBb26FlvOhtzyiUC0E1Wkg";
String[] chunks = payload.split("\\.");
        ...
        System.out.println(payload.substring(begin + 8, end-3));
        }
