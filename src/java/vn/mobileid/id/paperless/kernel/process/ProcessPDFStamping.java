 ...
 * @author GiaTK
 */
public class ProcessPDFStamping {

    //<editor-fold defaultstate="collapsed" desc="Process PDF Stamping">
    ...
    //<editor-fold defaultstate="collapsed" desc="Process PDF Stamping - Call throught Qrypto">
    public static InternalResponse processV2(
        ...
        try {
            ...
            return new InternalResponse(
                    ...
                    PaperlessMessageResponse.getErrorMessage(
                            PaperlessConstant.CODE_INVALID_PARAMS_WORKFLOWACTIVITY,
                            PaperlessConstant.SUBCODE_CANNOT_DECODE_FILE_DATA,
                            "en",
                            transactionID)
            );
        }
