...
//        System.out.println("TransactionId:"+woAc.getTransaction());
        ...
        //From info of transaction. Get fileManagement or QR or CSV
...
//        System.out.println("Transaction:"+transaction.getObject_type().name());
        switch (transaction.getObject_type().getNumber()) {
            case 1: {
                //<editor-fold defaultstate="collapsed" desc="Get QR Image">
            ...
            case 2: {
                //<editor-fold defaultstate="collapsed" desc="Get CSV File">
                response = GetCSVTask.getCSVTask_noneGetFromFMS(transaction.getObject_id(), transactionID);
                if(response.getStatus() != PaperlessConstant.HTTP_CODE_SUCCESS){return response;}
                
                //Download from FMS
                CSVTask csv = (CSVTask)response.getData();
                response = DownloadFromFMS.download(csv.getUuid(), transactionID);
                if(response.getStatus() != PaperlessConstant.HTTP_CODE_SUCCESS){return response;}
            ...
            case 3: {
                //<editor-fold defaultstate="collapsed" desc="Get PDF file">
