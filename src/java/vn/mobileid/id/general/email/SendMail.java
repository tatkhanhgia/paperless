    ...
    */
    ...
    public SendMail(
        ...
        if (template == null) {
            ...
            this.Subject = template.getSubject().replace(AnnotationJWT.Name.getNameAnnot(), name == null ? "" : name);
            this.Subject = this.Subject.replace(AnnotationJWT.DocNumber.getNameAnnot(), CCCD == null ? "" : CCCD);
            this.Content = template.getBody().replace(AnnotationJWT.Name.getNameAnnot(), name == null ? sendTo : name);
        }
